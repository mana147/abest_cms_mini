...
router.post('/courses', verifyCsrf, uploadImage, courseController.store);
router.get('/courses/:id/edit', courseController.adminEditForm);
router.post('/courses/:id', verifyCsrf, uploadImage, courseController.update);
...
router.post('/teachers', verifyCsrf, uploadImage, teacherController.store);
router.get('/teachers/:id/edit', teacherController.adminEditForm);
router.post('/teachers/:id', verifyCsrf, uploadImage, teacherController.update);
...
router.post('/testimonials', verifyCsrf, uploadImage, testimonialController.store);
router.get('/testimonials/:id/edit', testimonialController.adminEditForm);
router.post('/testimonials/:id', verifyCsrf, uploadImage, testimonialController.update);
...
router.post('/posts', verifyCsrf, uploadImage, postController.store);
router.get('/posts/:id/edit', postController.adminEditForm);
router.post('/posts/:id', verifyCsrf, uploadImage, postController.update);
...
router.post('/documents', verifyCsrf, uploadPdf, documentController.store);
...
router.post('/gallery', verifyCsrf, uploadGallery, galleryController.store);
